<html>
    <head>
        <title><?php echo $_GET["uname"]; ?> | Offline Map Application</title>
        <meta charset="utf-8">
    ...
    <body>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="profile.php" class="dropdown-item"><i class="fas fa-user"> My Profile</i></a>
        ...
        <div id="mapid" style="height: 590px; width: 100%;"></div>

        <!-- Linking to the scripting for the map applications and any other JavaScript features I want to implement -->
