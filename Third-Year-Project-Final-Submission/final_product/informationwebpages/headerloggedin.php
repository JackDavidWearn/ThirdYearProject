...
<head lang="en">
    ...
    <!-- Link to external stylesheet and scripting files -->
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse flex-row-reverse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-user"> <?php echo $_SESSION['user_name']; ?></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../index.php?logout"><i class="fas fa-user-minus"> Logout</i></a>
                    </li>
                </ul>
            </div>
        </nav>